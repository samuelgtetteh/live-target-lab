...
Both log every event with a `[timestamp] OK/ALERT (injected normal/suspicious)` line, so you can visually compare what was *intended* against what the live model actually *detected*.
